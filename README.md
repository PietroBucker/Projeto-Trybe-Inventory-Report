...
-   Data para entrega regular do projeto:`04/09/2023 - 14:00h`.
...
-   No menu à direita, clique no _link_ **'Reviewers'** e digite `students`, selecione o time `tryber/students-sd-027-python`.
...
[Formulário de avaliação do projeto](https://be-trybe.typeform.com/to/ZTeR4IbH#cohort_hidden=CH27-PYTHON&template=betrybe/python-0x-projeto-inventory-report)
